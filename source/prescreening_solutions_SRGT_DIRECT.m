function [chosen_X, others_X, chosen_pred, index_SSM, info] = prescreening_solutions_SRGT_DIRECT(pop_X, P, N, n, lb, ub, params, info)
...
switch rule_choose_sample
    case 'kmeans'
        ...
        [chosen_X, others_X, chosen_pred, info] = using_one_metamodel_SRGT_DIRECT(P, sample_X, sample_y, N, n, lb, ub, type, params, info);
    case 'lowest'
        % Select a sample to build/update the metamodel
    ...
    case 'k_nearest'
        ...
        % Build the metamodel and choose N solutions from P (one solution per subpopulation)
        [chosen_X, others_X, chosen_pred, index_SSM, info] = using_several_metamodels_SRGT_DIRECT(P, pool, N, n, lb, ub, std_tol, k_nearest, type, params, info);

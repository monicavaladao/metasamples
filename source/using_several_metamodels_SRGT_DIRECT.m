function [chosen_X, others_X, chosen_pred, index_SSM, info] = using_several_metamodels_SRGT_DIRECT(P, pool, N, n, lb, ub, std_tol, k_nearest, type, params, info)
...
for i = 1:N_pop
    ...
    [model_info] = build_metamodel_OK_SRGT_DIRECT(sample_X, sample_y);

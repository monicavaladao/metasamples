...
parser.addParameter('ChooseSample', 'kmeans', @ischar);
...
switch n
    case 2
        params.pop_size = 20;
        params.sample_size = 80;
        params.choose_sample.nearest_points = 4;
    case 5
        params.pop_size = 20;
        params.sample_size = 80;
        params.choose_sample.nearest_points = 4;
    case 7 % Loudspeaker
        params.pop_size = 30;
        params.sample_size = 120;
        params.choose_sample.nearest_points = 4;
     case 9 % Microwave problem
        params.pop_size = 30;
        params.sample_size = 120;%100;
        params.choose_sample.nearest_points = 4;    
    case 10
        params.pop_size = 20;
        params.sample_size = 80;
    ...
    case 15
        ...
        params.choose_sample.nearest_points = 5;
    otherwise
        params.pop_size = 50;
        params.sample_size = 150;
        params.choose_sample.nearest_points = 3;
end
...
params.max_pool_size = 2*params.sample_size;

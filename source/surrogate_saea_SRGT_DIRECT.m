function [best_x, best_y, info] = surrogate_saea_SRGT_DIRECT(fobj, X, y, lb, ub, max_eval, varargin)
...
while eval_counter < params.max_eval
    ...
    [chosen_X, others_X, chosen_pred, index_SSM, info] = prescreening_solutions_SRGT_DIRECT(pop_X, P, N, n, lb, ub, params, info);
    ...
    info.pool = update_pool(pop_X, chosen_X, chosen_y, index_SSM, info.pool, params);

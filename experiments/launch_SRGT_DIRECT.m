function [] = launch_SRGT_DIRECT(problem, metamodel, rule, seed, evolutioncontrol, dir_output, filename)
...
% Solve the problem
[best_x, best_y, info] = surrogate_saea_SRGT_DIRECT(fobj, X, y, lb, ub, neval, metamodel.params{:}, rule.choose_sample{:}, evolutioncontrol{:});
